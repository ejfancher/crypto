import cesaer_cipher as cc, simple_substitution_cipher as ssc, \
    transposition_cipher as tc, poly_alphabetic_cipher as pac, \
    beaufort_cipher as bc
...
def main():
    ...
    get.add_argument("cipher", help="enter 'caesar' for caesar cipher, \
